(()=>{"use strict";const e=[{func:class{constructor(){this.element=String.raw`
    ...
    `}},name:"Pasan",path:"/pasan"}];class t{constructor(e){const t=e.path;this.el=String.raw`
